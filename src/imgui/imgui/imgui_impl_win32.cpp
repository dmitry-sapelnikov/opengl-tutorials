...
// This needs to be used along with a GraphicsDevice (e.g. DirectX11, OpenGL3, Vulkan..)
...
IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandlerEx(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam, ImGuiIO& io)
{
    ...
    case WM_XBUTTONDOWN: case WM_XBUTTONDBLCLK:
    {
        ...
        /// \FIXME: this code is currently commented because it causes jitter of the camera drag
